-- PHASE 1 CONTINUED: Fix scraping_jobs and other critical tables
...
-- Add finite state machine for scraping jobs
...
ALTER TABLE public.scraping_jobs 
  ADD CONSTRAINT IF NOT EXISTS scraping_jobs_status_chk 
