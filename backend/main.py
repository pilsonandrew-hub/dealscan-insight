...
import importlib
_routers = {}
for _rname in ["auth", "vehicles", "opportunities", "upload", "ml", "admin", "ingest", "rover", "outcomes", "analytics", "sniper", "saved_searches", "vin", "recon"]:
    try:
...
# debug/recon-test endpoint removed 2026-03-21 (was unauthenticated in prod)
