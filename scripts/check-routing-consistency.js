...
const ROOT = '/Users/andrewpilson/.openclaw/workspace';
...
const HELPER_PATH = path.join(ROOT, 'scripts/javarious-task-handoff-helper.js');
const GOVERNOR_PATH = path.join(ROOT, 'scripts/paperclip-routing-governor.js');
const TEST_PATH = path.join(ROOT, 'scripts/paperclip-routing-governor.test.js');
const BRIDGE_PATH = path.join(ROOT, 'scripts/paperclip-openrouter-bridge.js');
