...
-- Fixed version without duplicate index
...
-- Add critical performance indexes (check for existing ones first)
...
ALTER TABLE public.opportunities ADD CONSTRAINT IF NOT EXISTS fk_opportunities_listing 
...
-- Update timestamps trigger function (already exists but ensure it's there)
