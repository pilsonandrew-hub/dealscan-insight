...
SERVICE_KEY="SUPABASE_SERVICE_ROLE_KEY_REDACTED"
BOT_TOKEN="TELEGRAM_BOT_TOKEN_REDACTED"
CHAT_ID="-1003672399222"

python3 << 'PYEOF'
import json, urllib.request, urllib.parse, ssl, datetime, os, sys

SUPABASE_URL = "https://lbnxzvqppccajllsqaaw.supabase.co"
SERVICE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6Imxibnh6dnFwcGNjYWpsbHNxYWF3Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3MzIwMTQ3MSwiZXhwIjoyMDg4Nzc3NDcxfQ.gLFMWuEVDbwMMHYL1CPRwNv1oGukhBTFYZGYTuXftSg"
BOT_TOKEN = "TELEGRAM_BOT_TOKEN_REDACTED"
CHAT_ID = "-1003672399222"  # Dealerscope Alerts channel
...
# Get already-alerted IDs from alert_log
alerted_ids = set()
try:
...
# Query hot deals (DOS >= 80, not yet alerted)
