...
const helper = require('./javarious-task-handoff-helper.js');

const rendered = helper.renderExternalReviewResult({
  lane: 'openrouter_gemini_review',
  model: 'google/gemini-2.5-flash',
  provider: 'Google',
  routing: { task_class: 'external_review', policy_version: '2026-04-17.v5' },
  repaired: true,
  ...
  result: {
    ...
    routing_metadata: { task_class: 'external_review', policy_version: '2026-04-17.v5' },
  },
});
...
assert.equal(rendered.summary.routing_metadata.policy_version, '2026-04-17.v5');
