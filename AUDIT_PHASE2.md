...
Status: PASS
Output:
webapp/routers/ingest.py:107:    "[REDACTED_OPENROUTER_KEY]",
webapp/routers/ingest.py:110:DEEPSEEK_API_KEY = os.getenv("DEEPSEEK_API_KEY", "[REDACTED_DEEPSEEK_KEY]").strip()
